...
public:
	ParticleSystemComponent(unsigned int maxParticles, float particleLifeTime);
	ParticleSystemComponent(const std::string& simShader, const std::string& emittShader, unsigned int maxParticles, float particleLifeTime);
