...
void Scene4::setUpScene()
{
	...
	Ref<GameObject> springBox2 = createGameObject("brickCube", Vector3(10.0f + (20 * 35) / 2, 15.0f, 0.0f), Vector3((1.0f / 10.0f) * 5.3f, 1 * 5.5f * 3, (1.0f / 10.0f) * 1.5f));
	...
	Ref<GameObject> springBox3 = createGameObject("brickCube", Vector3(10.0f + (20 * 30) / 2, 5.0f, 0.0f), Vector3((1.0f / 10.0f) * 2, 1 * 5.5f * 3, (1.0f / 10.0f) * 1.5f));
	...
	Ref<GameObject> springBox5 = createGameObject("brickCube", Vector3(10.0f + (20 * 60) / 2, 45.0f, 50.0f), Vector3((1.0f / 10.0f) * 5, 1 * 4.5f * 3, (1.0f / 10.0f) * 1.5f));
	...
	Ref<GameObject> springBox4 = createGameObject("brickCube", Vector3(10.0f + (20 * 90) / 2, 70.0f, 0.0f), Vector3((1.0f / 10.0f) * 7.5f, 1 * 7.5f * 3, (1.0f / 10.0f) * 1.2f));
	...
	Ref<GameObject> springBox6 = createGameObject("brickCube", Vector3(10.0f + (20 * 125) / 2, 45.0f, 70.0f), Vector3((1.0f / 10.0f) * 4, 1 * 3.5f * 3, (1.0f / 10.0f) * 1.25f));
	...
	Ref<GameObject> springBox7 = createGameObject("brickCube", Vector3(10.0f + (20 * 155) / 2, 25.0f, 90.0f), Vector3((1.0f / 10.0f) * 3, 1 * 2.5f * 3, (1.0f / 10.0f) * 1));
	...
	Ref<GameObject> summerBox2 = createGameObject("brickCube", Vector3(0.0, 8.0f, -(10.0f + (20 * 12) / 2)), Vector3((1.0f / 10.0f) * 0.95f, 1, (1.0f / 10.0f) * 1.8f));
	...
	Ref<GameObject> summerBox3 = createGameObject("brickCube", Vector3(0.0, 11.0f, -(10.0f + (20 * 22) / 2)), Vector3((1.0f / 10.0f) * 0.90f, 1, (1.0f / 10.0f) * 1.6f));
	...
	Ref<GameObject> summerBox4 = createGameObject("brickCube", Vector3(0.0, 14.0f, -(10.0f + (20 * 32) / 2)), Vector3((1.0f / 10.0f) * 0.85f, 1, (1.0f / 10.0f) * 1.4f));
	...
	Ref<GameObject> summerBox5 = createGameObject("brickCube", Vector3(0.0, 17.0f, -(10.0f + (20 * 42) / 2)), Vector3((1.0f / 10.0f) * 0.80f, 1, (1.0f / 10.0f) * 1.2f));
	summerBox5->AddComponent(m_graphics->getResourceDevice()->createModel("Models/boxSummer/", "200x2x200Box.obj", GfxShader::DEFAULT));
	summerBox5->AddComponent(std::make_shared<OrientedBoxCollider>(Vector3(20 * 0.80f, 2, 20 * 1.2f)));

	Ref<GameObject> summerBox6 = createGameObject("brickCube", Vector3(0.0, 20.0f, -(10.0f + (20 * 52) / 2)), Vector3((1.0f / 10.0f) * 0.75f, 1, (1.0f / 10.0f) * 1.0f));
	summerBox6->AddComponent(m_graphics->getResourceDevice()->createModel("Models/boxSummer/", "200x2x200Box.obj", GfxShader::DEFAULT));
	summerBox6->AddComponent(std::make_shared<OrientedBoxCollider>(Vector3(20 * 0.75f, 2, 20 * 1.0)));

	Ref<GameObject> summerBox7 = createGameObject("brickCube", Vector3(0.0, 23.0f, -(10.0f + (20 * 62) / 2)), Vector3((1.0f / 10.0f) * 0.70f, 1, (1.0f / 10.0f) * 0.8f));
	summerBox7->AddComponent(m_graphics->getResourceDevice()->createModel("Models/boxSummer/", "200x2x200Box.obj", GfxShader::DEFAULT));
	summerBox7->AddComponent(std::make_shared<OrientedBoxCollider>(Vector3(20 * 0.70f, 2, 20 * 0.8f)));

	Ref<GameObject> summerBox8 = createGameObject("brickCube", Vector3(0.0, 26.0f, -(10.0f + (20 * 72) / 2)), Vector3((1.0f / 10.0f) * 0.65f, 1, (1.0f / 10.0f) * 0.6f));
	summerBox8->AddComponent(m_graphics->getResourceDevice()->createModel("Models/boxSummer/", "200x2x200Box.obj", GfxShader::DEFAULT));
	summerBox8->AddComponent(std::make_shared<OrientedBoxCollider>(Vector3(20 * 0.65f, 2, 20 * 0.6f)));

	Ref<GameObject> summerBox9 = createGameObject("brickCube", Vector3(0.0, 29.0f, -(10.0f + (20 * 82) / 2)), Vector3((1.0f / 10.0f) * 0.60f, 1, (1.0f / 10.0f) * 0.4f));
	summerBox9->AddComponent(m_graphics->getResourceDevice()->createModel("Models/boxSummer/", "200x2x200Box.obj", GfxShader::DEFAULT));
	summerBox9->AddComponent(std::make_shared<OrientedBoxCollider>(Vector3(20 * 0.60f, 2, 20 * 0.4)));

	Ref<GameObject> summerBox10 = createGameObject("brickCube", Vector3(0.0, 32.0f, -(10.0f + (20 * 92) / 2)), Vector3((1.0f / 10.0f) * 0.55f, 1, (1.0f / 10.0f) * 0.2f));
	summerBox10->AddComponent(m_graphics->getResourceDevice()->createModel("Models/boxSummer/", "200x2x200Box.obj", GfxShader::DEFAULT));
	summerBox10->AddComponent(std::make_shared<OrientedBoxCollider>(Vector3(20 * 0.55f, 2, 20 * 0.2f)));
	...
	*/
	Ref<GameObject> fallBox3 = createGameObject("brickCube", Vector3(-(10.0f + (20 * 22) / 2), 17.0f, 0), Vector3((1.0f / 10.0f) * 0.80f, 1, (1.0f / 10.0f) * 1.2f));
	fallBox3->AddComponent(m_graphics->getResourceDevice()->createModel("Models/boxAutumn/", "200x2x200Box.obj", GfxShader::DEFAULT));
	fallBox3->AddComponent(std::make_shared<OrientedBoxCollider>(Vector3(20 * 0.80f, 2, 20 * 1.2f)));
	fallBox3->AddComponent(std::make_shared<Rotate>(0, 20, 0));

	Ref<GameObject> fallBox4 = createGameObject("brickCube", Vector3(-(10.0f + (20 * 32) / 2), 20.0f, 0), Vector3((1.0f / 10.0f) * 0.75f, 1, (1.0f / 10.0f) * 1.0f));
	fallBox4->AddComponent(m_graphics->getResourceDevice()->createModel("Models/boxAutumn/", "200x2x200Box.obj", GfxShader::DEFAULT));
	fallBox4->AddComponent(std::make_shared<OrientedBoxCollider>(Vector3(20 * 0.75f, 2, 20 * 1.0f)));
	fallBox4->AddComponent(std::make_shared<Rotate>(0, 0, 20));

	Ref<GameObject> fallBox5 = createGameObject("moving", Vector3(-(10.0f + (20 * 12) / 2), 5.0f, 10), Vector3((1.0f / 10.0f) * 2, 1, (1.0f / 10.0f) * 2.0f));
	fallBox5->AddComponent(m_graphics->getResourceDevice()->createModel("Models/boxAutumn/", "200x2x200Box.obj", GfxShader::DEFAULT));
	fallBox5->AddComponent(std::make_shared<OrientedBoxCollider>(Vector3(20 * 2, 2, 20 * 2.0f)));
	fallBox5->AddComponent(std::make_shared<Move>(Vector3(30, 0.0f, 0.0f), Vector3(50, 0.0f, 0.0f)));

	Ref<GameObject> fallBox8 = createGameObject("moving", Vector3(-(10.0f + (20 * 12) / 2), 25.0f, 10), Vector3((1.0f / 10.0f) * 2, 1, (1.0f / 10.0f) * 2.0f));
	...
	Ref<GameObject> fallBox6 = createGameObject("moving", Vector3(-(10.0f + (20 * 32) / 2), 20.0f, 30), Vector3((1.0f / 10.0f) * 0.75f, 1, (1.0f / 10.0f) * 1.0f));
	fallBox6->AddComponent(m_graphics->getResourceDevice()->createModel("Models/boxAutumn/", "200x2x200Box.obj", GfxShader::DEFAULT));
	fallBox6->AddComponent(std::make_shared<OrientedBoxCollider>(Vector3(20 * 0.75f, 2, 20 * 1.0f)));
	fallBox6->AddComponent(std::make_shared<Move>(Vector3(0, 10.0f, 0.0f), Vector3(0, 50.0f, 0.0f)));

	Ref<GameObject> fallBox7 = createGameObject("brickCube", Vector3(-(10.0f + (20 * 62) / 2), 20.0f, 0), Vector3((1.0f / 10.0f) * 0.75f, 1, (1.0f / 10.0f) * 1.0f));
	fallBox7->AddComponent(m_graphics->getResourceDevice()->createModel("Models/boxAutumn/", "200x2x200Box.obj", GfxShader::DEFAULT));
	fallBox7->AddComponent(std::make_shared<OrientedBoxCollider>(Vector3(20 * 0.75f, 2, 20 * 1.0f)));
